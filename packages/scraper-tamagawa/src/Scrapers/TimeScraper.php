...
/**
 * Reads the exhibition times Tamagawa publishes on its own site, which carries more of the run
 * than the official page does: the lap, turn and straight times as well. The stadium is fixed at 5.
 *
 * @author shimomo
 */
final class TimeScraper implements LocalScraper
{
     ...
     */
    private const string BASE_URL = 'https://boatrace-tamagawa.com';
    ...
    public static function scrape(
        ...
        $scraperUrl = sprintf($scraperFormat, self::BASE_URL, 'oriten', $date->format('Ymd'), $raceNumber);
