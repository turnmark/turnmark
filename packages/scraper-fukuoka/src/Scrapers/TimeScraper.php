...
use Turnmark\Scraper\Fukuoka\Contracts\Scraper;
...
final class TimeScraper implements Scraper
{
     ...
     */
    private static string $baseUrl = 'https://www.boatrace-fukuoka.com';
    ...
    public static function scrape(
        ...
        $scraperUrl = sprintf($scraperFormat, self::$baseUrl, 'tenji_info', $date->format('Ymd'), $raceNumber);
