...
final class ScraperDataProvider
{
     ...
     * >
     */
    public static function scrapeProgramProvider(): array
    {
        return [
            [
     ...
     *         expected: ExpectedByStadiumNumber,
     *     }
     * >
     */
    public static function scrapeProgramBulkProvider(): array
    {
        return [
            [
                'arguments' => [Carbon::parse('2026-05-31'), [6], [12]],
