...
/**
 * Reads the exhibition times Mikuni publishes on its own site, which carries more of the run
 * than the official page does: the lap, turn and straight times as well. The stadium is fixed at 10.
 *
 * @author shimomo
 */
